@extends('admins.layouts.master', ['titlePage' => 'Organization Types'])
@section('organization-types_active', 'active')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.organization-types.create') }}" class="btn btn-md btn-primary"><i
                        ...
                        <form action="{{ route('admin.organization-types.index') }}" method="GET"
                            ...
                            <div class="input-group" style="width: 600px;">
                                ...
                                <input type="text" class="form-control" name="name_search"
                                    placeholder="Search Organization types..." value="{{ request('name_search') }}">
