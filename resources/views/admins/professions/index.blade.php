@extends('admins.layouts.master', ['titlePage' => 'Profession'])
@section('professions_active', 'active')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.professions.create') }}" class="btn btn-md btn-primary"><i
                            class="fa-solid fa-square-plus"></i>
                        Create</a>

                    <div class="card-tools">
                        <form action="{{ route('admin.professions.index') }}" method="GET" class="d-flex align-items-center">
