@extends('admins.layouts.master', ['titlePage' => 'Skill'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.skills.create') }}" class="btn btn-md btn-primary"><i
                            class="fa-solid fa-square-plus"></i>
                        Create</a>

                    <div class="card-tools">
                        <form action="{{ route('admin.skills.index') }}" method="GET" class="d-flex align-items-center">
