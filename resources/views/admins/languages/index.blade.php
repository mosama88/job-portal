@extends('admins.layouts.master', ['titlePage' => 'Language'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.languages.create') }}" class="btn btn-md btn-primary"><i
                            class="fa-solid fa-square-plus"></i>
                        Create</a>

                    <div class="card-tools">
                        <form action="{{ route('admin.languages.index') }}" method="GET" class="d-flex align-items-center">
