        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.currencies.create') }}" class="btn btn-md btn-primary"><i
                            class="fa-solid fa-square-plus"></i>
                        Create</a>

                    <div class="card-tools">
                        <form action="{{ route('admin.currencies.index') }}" method="GET" class="d-flex align-items-center">
                            ...
                            <div class="input-group" style="width: 600px;">
                                ...
                                <input type="text" class="form-control" name="name_search"
                                    placeholder="Search Currency Or Country..." value="{{ request('name_search') }}">
