                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="box-step step-1">
                                <h1 class="number-element">
                                    <img src="{{ asset('frontend') }}/assets/imgs/template/icons/whu_choose_icon_1.png"
                                        alt="choose">
                                </h1>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="box-step step-2">
                                <h1 class="number-element">
                                    <img src="{{ asset('frontend') }}/assets/imgs/template/icons/whu_choose_icon_2.png"
                                        alt="choose">
                                </h1>
                        ...
                        <div class="swiper-wrapper pt-5">
                            <div class="swiper-slide">
                                ...
                                <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a
                                        ...
                                        <div class="item-logo">
                                            <div class="image-left"><img alt="joblist"
                                                    src="{{ asset('frontend') }}/assets/imgs/brands/brand-10.png">
                                            </div>
                                            <div class="text-info-right">
                ...
                <div class="row mt-50">
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                        <div class="card-image-top hover-up"><a href="jobs-grid.html">
                                <div class="image"
                                    style="background-image: url(frontend/assets/imgs/page/homepage1/location1.png);">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                        <div class="card-image-top hover-up"><a href="jobs-grid.html">
                                <div class="image"
                                    style="background-image: url(frontend/assets/imgs/page/homepage1/location2.png);">
                                    <span class="lbl-hot">Trending</span></div>
                            </a>
                            <div class="informations"><a href="jobs-grid.html">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                        <div class="card-image-top hover-up"><a href="jobs-grid.html">
                                <div class="image"
                                    style="background-image: url(frontend/assets/imgs/page/homepage1/location3.png);">
                                    <span class="lbl-hot">Hot</span></div>
                            </a>
                            <div class="informations"><a href="jobs-grid.html">
                                    <h5>New York, USA</h5>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                        <div class="card-image-top hover-up"><a href="jobs-grid.html">
                                <div class="image"
                                    style="background-image: url(frontend/assets/imgs/page/homepage1/location4.png);">
                                </div>
                            </a>
                            <div class="informations"><a href="jobs-grid.html">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                        <div class="card-image-top hover-up"><a href="jobs-grid.html">
                                <div class="image"
                                    style="background-image: url(frontend/assets/imgs/page/homepage1/location5.png);">
                                </div>
                            </a>
                            <div class="informations"><a href="jobs-grid.html">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                        <div class="card-image-top hover-up"><a href="jobs-grid.html">
                                <div class="image"
                                    style="background-image: url(frontend/assets/imgs/page/homepage1/location6.png);">
                                </div>
                            </a>
                            <div class="informations"><a href="jobs-grid.html">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                        <div class="card-image-top hover-up"><a href="jobs-grid.html">
                                <div class="image"
                                    style="background-image: url(frontend/assets/imgs/page/homepage1/location7.jpg);">
                                    <span class="lbl-hot">Hot</span></div>
                            </a>
                            <div class="informations"><a href="jobs-grid.html">
                                    <h5>Paris, France</h5>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                        <div class="card-image-top hover-up"><a href="jobs-grid.html">
                                <div class="image"
                                    style="background-image: url(frontend/assets/imgs/page/homepage1/location8.png);">
                                    <span class="lbl-hot">Trending</span></div>
                            </a>
                            <div class="informations"><a href="jobs-grid.html">
                                    <h5>London, England</h5>
                        ...
                        <div class="swiper-container swiper-group-4-border swiper">
                            <div class="swiper-wrapper pb-70 pt-5">
                                <div class="swiper-slide hover-up">
                                    <div class="card-review-1">
                                        <div class="image-review">
                                            <img src="{{ asset('frontend') }}/assets/imgs/page/homepage4/user.png"
                                                alt="joblist">
                                ...
                                <div class="swiper-slide hover-up">
                                    <div class="card-review-1">
                                        <div class="image-review">
                                            <img src="{{ asset('frontend') }}/assets/imgs/page/homepage4/user2.png"
                                                alt="joblist">
                                            <div class="review-name">
                                ...
                                <div class="swiper-slide hover-up">
                                    <div class="card-review-1">
                                        <div class="image-review">
                                            <img src="{{ asset('frontend') }}/assets/imgs/page/homepage4/user3.png"
                                                alt="joblist">
                                            <div class="review-name">
                                ...
                                <div class="swiper-slide hover-up">
                                    <div class="card-review-1">
                                        <div class="image-review">
                                            <img src="{{ asset('frontend') }}/assets/imgs/page/homepage4/user4.png"
                                                alt="joblist">
                                            <div class="review-name">
                            ...
                            <div class="swiper-wrapper pb-70 pt-5">
                                    ...
                                    <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                        <div class="text-center card-grid-3-image"><a href="#">
                                                <figure><img alt="joblist"
                                                        src="{{ asset('frontend') }}/assets/imgs/page/homepage1/img-news1.png">
                                                </figure>
                                            </a></div>
                                        <div class="card-block-info">
                                ...
                                <div class="swiper-slide">
                                    <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                        <div class="text-center card-grid-3-image"><a href="#">
                                                <figure><img alt="joblist"
                                                        src="{{ asset('frontend') }}/assets/imgs/page/homepage1/img-news2.png">
                                                </figure>
                                            </a></div>
                                        <div class="card-block-info">
                                ...
                                <div class="swiper-slide">
                                    <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                        <div class="text-center card-grid-3-image"><a href="#">
                                                <figure><img alt="joblist"
                                                        src="{{ asset('frontend') }}/assets/imgs/page/homepage1/img-news3.png">
                                                </figure>
                                            </a></div>
                                        <div class="card-block-info">
