        ...
        <div class="breacrumb-cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <h2 class="mb-20">Candidates Jobs</h2>
                        <ul class="breadcrumbs">
                            <li><a class="home-icon" href="{{ url('/') }}">Home</a></li>
                            <li>Candidates Jobs</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row flex-row-reverse">
                <div class="col-lg-9 col-md-12 col-sm-12 col-12 float-right">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-1 hover-up wow animate__animated animate__fadeIn">
                                        ...
                                        <div class="info-text mt-10">
                                            <h5 class="font-bold"><a href="#">{{ Str::limit($company->name, 20) }}</a>
                                            </h5>
                                            <div class="mt-5">
                                                <img alt="joblist"
                                            ...
                                            <div class="mt-30"><a class="btn btn-grey-big" href="#"><span>12</span>
                                                    <span>
                                                        Jobs
                                                        Open</span>
                                                </a>
                    ...
                    {{ $companies->links('frontend.pagination') }}
